...
<html lang="it">
	<head>
        ...
        <spring:url value="/resources/showBeer/header.js" var="showbeerheaderJS" />
        ...
        <script src="${showbeerheaderJS}"></script>
    ...
    <body>
        ...
        <header-search-beer author="${autore}" logo="${logoPNG}"
			search="showrecipesMake" lente="${lentePNG}"
			ingredients="location.href='editUserIng?nick=${autore}';" 
			tools="location.href='editUserEquip?nick=${autore}';"></header-search-beer>
